...
|   V²►Products Create | All essential pages of Products Board on V² are ready with sufficient content. These pages are the foundation of ViSite. |  
|     V²►Makers Create | Benefits of using missing standards. Road Map. |
|       V²►.DIY Create | Two categories of *How-to Articles* on custom building your own DIY Mini PC or All-In-One Computer: **1)** Generic DIY Custom Build PC Know How 2) *Ready Made* and tested *Custom Build PC Configurations*, optimized for different use case.|                                                            |
|     V²►Retail Create | Articles on benefits for Retailers on V² Modular PC, ViCase and ViPC |
|   V²►Speading Create | Launch of the Board that describes how to spread the word and products. The sub-site and all its pages / Articles are complete.                                                                                         |
